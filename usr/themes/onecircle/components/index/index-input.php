    ...
    <form id="input-form" class="post-form" action="<?php $this->options->loginAction(); ?>" method="post"
        ...
        <div class="textarea">
            ...
            <div>
                ...
                <div class="sc-AxjAm sc-AxirZ i-input" style="position: relative;width: fit-content;height: 27px;background-color: var(--panelColor);border-radius: 5px;bottom: -8px">
