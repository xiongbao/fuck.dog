...
class LoginDesigner_Plugin implements Typecho_Plugin_Interface
{
    ...
    {
        Typecho_Plugin::factory('admin/header.php')->header_2000 = array('LoginDesigner_Plugin', 'render');
        Typecho_Plugin::factory('admin/footer.php')->end_2000 = array('LoginDesigner_Plugin', 'footerjs');
    }
